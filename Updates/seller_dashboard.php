    ...
    if ($image['error'] == 0) {
        ...
        if (move_uploaded_file($image['tmp_name'], $image_path)) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: seller_dashboard.php"); // Refresh the page after adding
                exit();
            }else  {         
...
<head>
    ...
    <title>Seller Dashboard - Uzuri Africa</title>
    <style>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="seller_viewbids.php">View Bids</a></li>
        ...
        <tbody>
            <?php if (!empty($products)): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="seller_dashboard.php?edit=<?php echo $product['id']; ?>">Edit</a>
                        <a href="seller_dashboard.php?delete=<?php echo $product['id']; ?>" 
    ...
    ?>
    <h2>Update Item</h2>
    <form id="update-item-form" action="seller_dashboard.php" method="POST">
